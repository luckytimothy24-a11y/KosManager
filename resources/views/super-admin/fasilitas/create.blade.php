<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Tambah Fasilitas" description="Fasilitas dapat dipilih saat membuat atau mengedit kos / kamar.">
            ...
            <form method="POST" action="{{ route('super-admin.fasilitas.store') }}" class="space-y-5"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="relative flex items-center gap-3 p-4 rounded-xl border cursor-pointer transition {{ old('type', 'kamar') === 'kamar' ? 'border-primary-500 bg-primary-50/50 dark:bg-primary-500/10' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600' }}">
                            <input type="radio" name="type" value="kamar" {{ old('type', 'kamar') === 'kamar' ? 'checked' : '' }} class="sr-only">
                        ...
                        <label class="relative flex items-center gap-3 p-4 rounded-xl border cursor-pointer transition {{ old('type', 'kamar') === 'kos' ? 'border-primary-500 bg-primary-50/50 dark:bg-primary-500/10' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600' }}">
                            <input type="radio" name="type" value="kos" {{ old('type', 'kamar') === 'kos' ? 'checked' : '' }} class="sr-only">
