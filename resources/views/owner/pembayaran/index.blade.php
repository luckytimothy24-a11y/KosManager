                                ...
                                <td class="px-4 py-3.5">
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        @if($p->verification_status === 'pending')
                                            <form method="POST" action="{{ route("$prefix.pembayaran.verify", $p) }}"
                                                ...
                                                <button type="submit"
                                                        ...
                                                        title="Verifikasi sebagai Lunas" aria-label="Verifikasi pembayaran {{ $p->payment_number }}">
                                                ...
                                                <div x-data="{ reason: '' }" class="space-y-4">
                                                    ...
                                                    <form method="POST" action="{{ route("$prefix.pembayaran.reject", $p) }}" @submit="if (!reason.trim()) { alert('Alasan penolakan wajib diisi.'); event.preventDefault(); }">
                                                        ...
                                                        <div class="mt-4 flex justify-end gap-2">
                                                            ...
                                                            <button type="submit"
                                                                    class="px-4 py-2 text-sm font-bold text-white bg-red-600 rounded-xl hover:bg-red-700 transition shadow-sm shadow-red-600/30">Tolak Pembayaran</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </x-modal>
