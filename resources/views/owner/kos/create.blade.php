<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Tambah Kos" description="Buat data kos baru.">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="address" rows="2" required
                                  class="w-full rounded-lg border-gray-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500 text-sm @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                                  class="w-full rounded-lg border-gray-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500 text-sm">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="general_facilities" rows="2"
                                  class="w-full rounded-lg border-gray-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500 text-sm">{{ old('general_facilities') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="rules" rows="3"
                                  class="w-full rounded-lg border-gray-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500 text-sm">{{ old('rules') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="payment_info" rows="3"
                                  ...
                                  class="w-full rounded-lg border-gray-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500 text-sm">{{ old('payment_info') }}</textarea>
